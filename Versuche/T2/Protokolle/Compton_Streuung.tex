...
Während des Versuches verändern wir nur die Position des Szintillators $a_1$ und die Position der Halterung des Gammastrahlers $b_2$ um die gewünschten Winkel zu erreichen. Alle anderen Werte werden konstant gehalten und betragen folgende Werte:
\begin{center}
    \begin{tabular}{|c|c|}
        \hline
